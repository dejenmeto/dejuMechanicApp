...
// if there is path of env file outside of these relative path of app.js
// require("dotenv").config({path});

// Import the sanitizer module for auth of frontend xss checker
...
// Import the router. if you need ./routes/index
